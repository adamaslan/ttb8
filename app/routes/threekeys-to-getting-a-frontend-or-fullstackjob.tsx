  ...
  return (
    <div>
      <div className=" mx-3 lg:mx-36">
        ...
        />
        <p className="text-left font-serif text-lg font-bold tracking-tight sm:text-2xl lg:text-3xl"><br />
          ...
          potential employers.<br /><br /> Utilizing job search strategies such as We Work
        ...
        <div>
          <p className="text-left font-serif text-lg font-bold tracking-tight sm:text-2xl lg:text-3xl"><br />
            The three keys to becoming a successful Software Engineer are:<br /><br />
           <p className="text-left font-serif text-lg font-bold tracking-tight sm:text-2xl lg:text-4xl">L.A.B.</p><br />
          </p>
          <ol>
            <li className="text-left font-serif text-lg font-bold tracking-tight sm:text-2xl lg:text-3xl">
