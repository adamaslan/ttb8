...
import hero from "/robinhood-agentic-trading-ai-agents-market-access.jpg";
...
export const meta: MetaFunction = () => {
  return [
    ...
    { property: "og:description", content: "Robinhood’s Agentic Trading lets AI agents like Claude or Cursor execute stock trades automatically via MCP. Learn how this changes AI-driven investing and what" },
    { property: "og:type", content: "article" },
    { property: "twitter:card", content: "summary_large_image" },
    { property: "twitter:title", content: "Robinhood’s Agentic Trading: How AI Agents Are Getting Direct Market Access" },
    { property: "twitter:description", content: "Robinhood’s Agentic Trading lets AI agents like Claude or Cursor execute stock trades automatically via MCP. Learn how this changes AI-driven investing and what" },
    { property: "twitter:image", content: hero },
    { property: "linkedin:title", content: "Robinhood’s Agentic Trading: How AI Agents Are Getting Direct Market Access" },
    { property: "linkedin:description", content: "Robinhood’s Agentic Trading lets AI agents like Claude or Cursor execute stock trades automatically via MCP. Learn how this changes AI-driven investing and what" },
