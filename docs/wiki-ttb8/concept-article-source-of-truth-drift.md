...
date: 2026-08-24
type: concept
tags: [drift, articles, data-modeling, registry]
sources: [app/article-registry.json, app/routes.ts, app/routes/ai-articles.tsx, PR#43]
---
...
> ⚠️ Contradiction: `article-registry.json` claims 18 canonical articles; `app/routes.ts` serves ~59 total routes; `ai-articles.tsx` independently lists 40. No single file is a complete or accurate enumeration of "all articles," and no automated check compares them.
